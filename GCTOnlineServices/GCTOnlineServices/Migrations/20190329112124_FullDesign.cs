        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgencyOrClubName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnLetter = table.Column<string>(nullable: true),
                    RowNumber = table.Column<int>(nullable: false),
                    PerformanceTimeAndDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoldTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SoldTickets_Orders_OrderId",
                        column: x => x.OrderId,
